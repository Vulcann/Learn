...
public class BlogPostDAO {
    ...
    public BlogPostDAO(final DB blogDatabase) {
        ...
        postsCollection.ensureIndex( new BasicDBObject( "date", -1) );
        postsCollection.ensureIndex( new BasicDBObject( "tags", 1 ) );
        postsCollection.ensureIndex( new BasicDBObject( "permalink", 1 ));
    }
